...
export function renderSlate(card: CardData, accent: string): string {
  ...
  <tr>
    <td style="padding:24px 26px;">
      <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        <tr>
          <td style="padding-right:20px;vertical-align:middle;">${avatarBlock(card, accent, 90, 14)}</td>
          <td style="border-left:3px solid ${accent};padding-left:20px;vertical-align:middle;">
            ...
            ${contactBadges(contactLines(card), accent, "#cbd5e1")}
            ${socialBlock(card)}
          </td>
        </tr>
      </table>
