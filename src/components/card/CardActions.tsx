          ...
          return (
            <a
              ...
              {...(a.external
                ...
                : {})}
              className={cn(
                "flex items-center justify-start gap-2.5 rounded-xl border border-border bg-white font-semibold text-foreground transition-colors hover:bg-surface w-full",
